...
![ScreenShot](https://github.com/VijayCreativeCapsule/TodoApp/blob/main/screenshots/scree1.jpeg =100x20)
...
```
git clone https://github.com/VijayCreativeCapsule/TodoApp TodoApp
```
